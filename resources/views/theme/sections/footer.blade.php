<footer class="mt-24">
    <div class="relative">
        ...
        <div class="relative flex justify-center">
            <span class="bg-background px-4 text-gray-500">
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div class="mt-8 md:mt-0 md:order-2 text-gray-500">
        ...
        <div class="mt-8 md:mt-0 md:order-1">
            <p class="flex items-center justify-center gap-x-2 text-center text-base text-gray-400">Cooked with
